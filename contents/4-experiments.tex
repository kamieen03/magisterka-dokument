...
\cite{bekkers2019}.
%TODO: describe projection layer
...
\subsection{Degree of equivariance and invariance}
    ...
    \begin{figure}[h!]
        \centering
        \begin{subfigure}{0.7\textwidth}
            \includegraphics[width=\linewidth]{plots/plot8/stl10_norms}
        \end{subfigure}
        \begin{subfigure}{0.7\textwidth}
            \includegraphics[width=\linewidth]{plots/plot8/cifar100_norms}
        \end{subfigure}
        \begin{subfigure}{0.7\textwidth}
            \includegraphics[width=\linewidth]{plots/plot8/cifar10_norms}
        \end{subfigure}
